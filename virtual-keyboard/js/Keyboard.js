...
const main = create('main', '', [
  ...
  create('h3', 'subtitle', 'Keyboard created in Windows operating system'),
  create(
    'p',
    'hint',
    'Use left <kbd>Ctrl</kbd> + <kbd>Alt</kbd> to switch language. Last language is saved in localStorage'
  ),
]);
